...
export const envConfig = {
  ...
  GH_API_BASE_URL: optionalStrValidator({ default: undefined }),
  GH_OAUTH_BASE_URL: optionalStrValidator({ default: undefined }),
  GH_OAUTH_TOKEN_BASE_URL: optionalStrValidator({ default: undefined }),
