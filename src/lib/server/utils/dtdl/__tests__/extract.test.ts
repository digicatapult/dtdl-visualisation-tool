...
import type { DtdlEntity } from '../../../models/dtdlOmParser.js'
...
describe('getDisplayName', function () {
  test('should return "Entity not found in model" for undefined entity', function () {
    expect(getDisplayName(undefined as unknown as DtdlEntity)).to.equal('Entity not found in model')
  })

  test('should return display name when available', function () {
    const entity = {
      displayName: { en: 'Test Display Name' },
    } as unknown as DtdlEntity
...
describe('getSchemaDisplayName', function () {
  ...
  test('should return "Entity not found in model" for undefined entity', function () {
    expect(getSchemaDisplayName(undefined as unknown as DtdlEntity)).to.equal('Entity not found in model')
  })
})
